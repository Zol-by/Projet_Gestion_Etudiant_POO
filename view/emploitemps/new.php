      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="container">
          ...
          <div style="text-align: center;">
            <h4 style="color: white;"><strong>ENREGISTREMENT DES ETUDIANTS</strong></h4>
          </div>
          ...
          <form action="#" method="get" class="register-wthree">
            ...
            <div class="mt-4">
              <button type="submit" class="btn btn-primary btn-block w-100"><strong>ENREGISTRER L'EMPLOI DU TEMPS</strong></button></br>
            </div>
          </form>
